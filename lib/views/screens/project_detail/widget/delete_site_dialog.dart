...
class DeleteSiteDialog extends StatefulWidget {
  const DeleteSiteDialog({super.key, required this.yesOnTap});
    ...
    return await showCupertinoDialog(
      ...
      builder: (context) {
        return WillPopScope(
          ...
          child: DeleteSiteDialog(yesOnTap: yesOnTap),
        );
      },
    );
  }
  ...
  @override
  State<DeleteSiteDialog> createState() => _DeleteSiteDialogState();
}

class _DeleteSiteDialogState extends State<DeleteSiteDialog> {
  @override
